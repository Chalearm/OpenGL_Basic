...
// the function netAnimationFrame() registered as the idle function.
...
// to GL_PROJECTION and then setting the matrix.
// perspective-projection-making matrix from the GL utility library. Here
