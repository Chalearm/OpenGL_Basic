/**
	...
	MAC OS :
	gcc glRobotarm2.c -framework GLUT -framework OpenGL -L"/System/Library/Frameworks/OpenGL.framework/Libraries" -lm -lobjc -lstdc++ -o glRobotarm2
...
static int shoulderAngle = 0, elbowAngle = 0, elbowAngle2 = 0;
...
void keyboard(unsigned char key, int x,int y)
{
	switch(key)
	{
		...
		case 'n': elbowAngle = (elbowAngle +5)%360; break;
		case 'm': elbowAngle = (elbowAngle -5)%360; break;
		default:
		 break;
	}
